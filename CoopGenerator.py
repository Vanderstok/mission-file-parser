...
class ModeFrame(tk.Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.player_slots = ["Blue leader", "Blue wingman", "Red leader", "Red wingman"]
        ...
        tk.Label(self, text="      You will fly for ").pack(side=tk.LEFT, pady=7)
        self.side = tk.IntVar()
        self.side.set(int(self.parent.mission_config.side_c))
        self.r3 = tk.Radiobutton(self, text="Allied", variable = self.side, value = 1, indicatoron = 0, width =10)
        self.r3.pack(anchor = tk.W, side = tk.LEFT, padx=5 )
        self.r4 = tk.Radiobutton(self, text="Axis", variable = self.side, value = 2, indicatoron = 0, width =10 )
        self.r4.pack(anchor = tk.W, side = tk.LEFT, padx=5)
        self.r5 = tk.Radiobutton(self, text="Both", variable = self.side, value = 0, indicatoron = 0, width =10 )
        ...
        self.player_slot_menu.pack(side=tk.LEFT, padx=5)
    ...
    def show_coop(self):
        self.line_1.pack_forget()
        self.r5.config(state=tk.ACTIVE)
 
    def show_single(self):
        if self.side.get() == 0:
            self.side.set(1)
        self.line_1.pack(side=tk.LEFT, padx=20)
    ...
    def create_mission(self):
        if self.parent.mission_config.il2_path != "":
            ...
            try:
                ...
                map_name = self.parent.mission_config.mission_map
                msbin = self.parent.mission_config.create_msbin
                date = self.parent.weather_frame.mission_date
                MissionConstructor.GenerateMission( mission_name, template_path, map_name, date, msbin )
...
if __name__ == "__main__":
    ...
    root.maxsize(width=720, height=900)
    root.title("Coop Mission Creator for IL2 BOX v8b")
    root.mainloop()
